...
from bayescache.augmentations.normalize import Normalize
from bayescache.augmentations.to_tensor import ToTensor
from bayescache.augmentations.to_array import ToArray


def create(model_config, batch_size, normalize=True, num_workers=0, augmentations=None):
    """Create a MNIST dataset, normalized from config file."""
...
def new(path, batch_size, normalize=True, num_workers=0, augmentations=None):
